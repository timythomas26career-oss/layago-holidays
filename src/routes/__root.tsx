...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    reportLayagoError(error, { boundary: "tanstack_root_error_component" });
  }, [error]);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "Layago Holidays â€” Luxury Travel Discovery" },
        {
          name: "description",
          content: "Curated luxury travel destinations and booking.",
        },
